      ...
      <div className="lg:my-20 my-10">
        <section className=" bg-gray-200 text-gray-800">
          <div className="container flex flex-col items-center mx-auto md:p-10 md:px-12">
            ...
            <p className="p-4 font-semibold leading-none text-center">
              What our customers are saying about us
            </p>
          </div>
            ...
            <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
              <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-gray-50">
                <p className="relative px-6 py-1 text-lg italic text-center text-gray-800">
                  ...
                  I have bought products from this shop before. The company
                  supplied me with excellent products at the right time. I wish
                  you success.
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
      ...
      <div className="my-10">
        <div className="grid p-4 w-full grid-cols-1 gap-8 py-16 rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 bg-gray-100 text-gray-800">
          <div className="flex flex-col justify-between">
            ...
            <img
              src="https://i.postimg.cc/mDM81pKS/loudspeaker-1459128-640.png"
              alt=""
              className="p-6 h-96 w-96"
            />
          </div>
          <form noValidate="" className="space-y-6">
            <div>
              ...
              <input
                ...
                type="text"
                placeholder=""
                className=" w-full p-3 rounded bg-gray-100 border-4"
              />
            </div>
            <div>
